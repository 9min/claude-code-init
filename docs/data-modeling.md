...
INSERT INTO todos (id, user_id, title, is_completed) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', '첫 번째 할 일', false),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000003', '두 번째 할 일', true);
-- 위 UUID는 예시값이다. 실제 사용자 UUID로 교체하여 사용한다.
```
